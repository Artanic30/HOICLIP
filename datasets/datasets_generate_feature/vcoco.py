    ...
    def __getitem__(self, idx):
        ...
        if self.img_set == 'train':
            ...
            for hoi in img_anno['hoi_annotation']:
                ...
                obj_cls.append(verb_obj_pair[1])
                hoi_cls.append(list(vcoco_hoi_text_label).index(verb_obj_pair))

                if list(vcoco_hoi_text_label).index(verb_obj_pair) > 260:
                    print(list(vcoco_hoi_text_label).index(verb_obj_pair))
                if list(vcoco_hoi_text_label).index(verb_obj_pair) < 1:
                    print(list(vcoco_hoi_text_label).index(verb_obj_pair))
